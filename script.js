...
let search_btn = document.getElementById("search-btn").addEventListener("click", (e)=> {
    ...
    .then(data =>{
        setTimeout(() => {
            ...
            image.insertAdjacentHTML('afterbegin',`<div id="img"><img src="${photo.urls.small}" /><a href ="https://unsplash.com/photos/${photo.id}/download?force=true"><i class='fas fa-download download'></i></a></div>`)
            });
        }, 1000);
